...
//================================================== TEST CODE ========================================//
	$app->get("/test", function (Request $request, Response $response, $args){
		$postencript = "YXk5RWNHMUhOVVU0VUROR1VGVjRNR0ZVYTNkblFrSTFVSGxZVFd0SmRHMXVlblJtTjNaekx6UkdXVDA9";
...
// ---------------------------------- HRD APP -----------------------------------------------
	...
	$app->get("/hrd/loading/search/{inview}", function (Request $request, Response $response, $args){
		...
		// $sqll = "SELECT  FROM `level_detail` where id='$idus' AND level_id='19'";
